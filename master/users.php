...
<div class="card">
    <div class="card-header flex-wrap gap-2">
        ...
        <form method="GET" class="search-wrapper" style="width:280px">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <?php if ($u['id'] != $user['id']): ?>
                                <form method="POST" onsubmit="return confirm('Yakin hapus pengguna ini?')" style="display:inline">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="e_reset">Reset password Admin ke default (<code>password</code>) — hanya jika role Admin</label>
                        </div>
                    </div>
                </div>
            </div>
